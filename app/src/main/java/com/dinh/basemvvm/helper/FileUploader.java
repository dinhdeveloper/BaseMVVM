package com.dinh.basemvvm.helper;

import android.os.Handler;
import android.os.Looper;
import android.text.TextUtils;

import com.dinh.basemvvm.api.ApiClient;
...
public class FileUploader {
    ...
    private DemoModel itemBookingModel;

    private interface UploadInterface {
        //        @Headers(Consts.HEADES)
        @POST(Consts.REST_ENDPOINT)
        Call<BaseResponseModel<DemoModel>> uploadFile(@Body RequestBody params);
    }
    ...
    public void uploadFiles(DemoModel itemBookingModel, File[] files, FileUploaderCallback fileUploaderCallback) {
    ...
    private void uploadSingleFile(final int index) {
        ...
        builder.addFormDataPart("product_id", itemBookingModel.getUsername());
        ...
        Call<BaseResponseModel<DemoModel>> call;
        call = uploadInterface.uploadFile(requestBody);

        call.enqueue(new Callback<BaseResponseModel<DemoModel>>() {
            @Override
            public void onResponse
                    (Call<BaseResponseModel<DemoModel>> call, retrofit2.Response<BaseResponseModel<DemoModel>> result) {
            ...
            @Override
            public void onFailure(Call<BaseResponseModel<DemoModel>> call, Throwable t) {
